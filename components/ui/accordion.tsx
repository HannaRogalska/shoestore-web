      ...
      >
        ...
        {variant === "footer" ? (
          <>
            ...
            <ChevronDown className="block h-4 w-4 [[data-state=open]>&]:hidden" />
          </>
        ) : (
          <>
...
function AccordionContent({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "[&_a]:hover:text-foreground h-(--radix-accordion-content-height) pt-0 pb-2.5 [&_p:not(:last-child)]:mb-4",
          className,
        )}
      >
        {children}
